    ...
    return(
        ...
        <div className="About-Page bg-gray-50">
            ...
            <div className="flex flex-wrap items-center justify-evenly">
                <div className="flex flex-col justify-start gap-4 w-[40vw] p-[60px] ">
            ...
            {/* Section Two */}
            <div className="flex flex-wrap justify-evenly p-[60px] ">
                <div className="p-[30px] w-[40vw] flex flex-col gap-4 items-center shadow hover:shadow-lg hover:backdrop-blur-lg transition-all rounded-xl ">
